...
|-------|-------------|------|
| [skill-creator](curated/core/skill-creator/) | Create, improve, evaluate, and benchmark Agent Skills — Anthropic's official skill authoring toolkit | `curated/core/skill-creator/` |

### AI

| Skill | Description | Path |
|-------|-------------|------|
| [mcp-builder](curated/ai/mcp-builder/) | Build high-quality MCP servers in TypeScript or Python — research, implement, test, and evaluate | `curated/ai/mcp-builder/` |
| [claude-api](curated/ai/claude-api/) | Claude API and Anthropic SDK reference — models, streaming, tools, MCP, agents, caching, migration | `curated/ai/claude-api/` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [doc-coauthoring](curated/documentation/doc-coauthoring/) | Structured workflow for co-authoring specs, proposals, PRDs, RFCs, and decision docs | `curated/documentation/doc-coauthoring/` |
| [docx](curated/documentation/docx/) | Create, read, edit, and manipulate Word documents (.docx) with professional formatting | `curated/documentation/docx/` |
| [pdf](curated/documentation/pdf/) | PDF processing — extract, merge, split, forms, encryption, OCR, and image extraction | `curated/documentation/pdf/` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [find-skills](curated/productivity/find-skills/) | Discover and install agent skills from the open ecosystem via the Skills CLI and skills.sh | `curated/productivity/find-skills/` |